...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto c45bfd6e601a414abffeb9b2d71574a4 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot ila_0 xil_defaultlib.ila_0 xil_defaultlib.glbl -log elaborate.log
}
