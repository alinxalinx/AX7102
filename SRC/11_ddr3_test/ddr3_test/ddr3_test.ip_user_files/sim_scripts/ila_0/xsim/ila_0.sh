...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto adff709989c34bbf8bc1fd2f7a78f328 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot ila_0 xil_defaultlib.ila_0 xil_defaultlib.glbl -log elaborate.log
}
