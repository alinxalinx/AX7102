...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 0c414c4695b3484b93d4de887485a853 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}
