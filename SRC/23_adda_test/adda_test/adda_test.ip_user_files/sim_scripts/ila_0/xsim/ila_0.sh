...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto ec512b1a14e04f299f5cde55fefd0e68 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot ila_0 xil_defaultlib.ila_0 xil_defaultlib.glbl -log elaborate.log
}
