...
video_packet_rec video_packet_rec_m0(
    ...
    assign probe0[31:0] = rx1_data_align;
    assign probe0[35:32] = rx1_ctrl_align;
    assign probe0[67:36] = vout_data;
    assign probe0[71:68] = rx0_kchar;
    assign probe0[72] = gt0_txfsmresetdone;
    assign probe0[73] = 0;
    assign probe0[105:74] = tx0_data;   
    assign probe0[109:106] = tx0_kchar;

    assign probe0[127 : 110] = 0;
//-------------------------------------
//Camera采样部分
wire        sys_we;
