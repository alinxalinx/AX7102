...
#
# Generated by Vivado on Mon Oct 17 11:15:24 +0800 2016
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../../ov5640_ddr_vga/ov5640_ddr_vga/ov5640_ddr_vga.srcs/sources_1/ip/pll/pll_clk_wiz.v" \
    "$ref_dir/../../../../../ov5640_ddr_vga/ov5640_ddr_vga/ov5640_ddr_vga.srcs/sources_1/ip/pll/pll.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.pll xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.pll -input simulate.do
}
# Script usage
usage()
{
