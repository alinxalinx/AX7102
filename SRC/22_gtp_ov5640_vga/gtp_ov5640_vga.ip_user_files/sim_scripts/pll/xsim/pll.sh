...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 314fc108c7664bbfb1bbd6283f3b5d85 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}
