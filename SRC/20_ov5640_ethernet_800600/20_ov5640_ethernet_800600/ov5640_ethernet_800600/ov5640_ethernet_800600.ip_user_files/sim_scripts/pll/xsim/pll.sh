...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto da133126408048da9980ae75fe5e0c47 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}
