...
#
# Generated by export_simulation on Thu Mar 16 13:39:03 +0800 2017
#
################################################################################
...
switch to the './pll_lcd.sh' script.

./pll_lcd.sh -reset_run
...
./pll_lcd.sh -noclean_files

For more information on the script, please type './pll_lcd.sh -help'.
