...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto f3d03c906cf14f7d841fdda22b5c32b9 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot PLL xil_defaultlib.PLL xil_defaultlib.glbl -log elaborate.log
}
