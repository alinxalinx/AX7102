...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto ad8cbb1274cf4b1580787da2450906f3 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot pll xil_defaultlib.pll xil_defaultlib.glbl -log elaborate.log
}
