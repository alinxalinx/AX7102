...
(
	...
	.wr_addr			           (29'd0),			        //ddr start write address
	.wr_max_addr		           (29'd49152),		     //ddr max write address 1024*768 *16bit/256bit
	.rd_addr			           (29'd0),			        //ddr start read address
	.rd_max_addr		           (29'd49152),		     //sdram max read address 1024*768 *16bit/256bit
