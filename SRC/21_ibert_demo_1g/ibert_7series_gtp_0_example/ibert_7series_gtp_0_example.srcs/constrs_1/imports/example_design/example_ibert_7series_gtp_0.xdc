...
## Refclk constraints
##
create_clock -name gtrefclk0_1 -period 6.735 [get_ports GTREFCLK0P_I[0]]
create_clock -name gtrefclk1_1 -period 6.735 [get_ports GTREFCLK1P_I[0]]
set_clock_groups -group [get_clocks gtrefclk* -include_generated_clocks] -asynchronous
##
## TX/RX out clock constraints
##
# GT X0Y4
create_clock -name Q1_RXCLK0 -period 13.468 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[0].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK0] -asynchronous
create_clock -name  Q1_TX0 -period 13.468 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[0].u_ch/u_gtpe2_channel/TXOUTCLK}]
set_clock_groups -group [get_clocks Q1_TX0] -asynchronous
# GT X0Y5
create_clock -name Q1_RXCLK1 -period 13.468 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[1].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK1] -asynchronous
# GT X0Y6
create_clock -name Q1_RXCLK2 -period 13.468 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[2].u_ch/u_gtpe2_channel/RXOUTCLK}]
set_clock_groups -group [get_clocks Q1_RXCLK2] -asynchronous
# GT X0Y7
create_clock -name Q1_RXCLK3 -period 13.468 [get_pins {u_ibert_core/inst/QUAD[0].u_q/CH[3].u_ch/u_gtpe2_channel/RXOUTCLK}]
...
set_property RXOUT_DIV 4 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
set_property TXOUT_DIV 4 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
 ##-----------------Eyescan--------------
...
set_property RXCDR_CFG 83'h0001107FE086021101010 [get_cells u_ibert_core/inst/QUAD[0].u_q*/CH[*].u_ch/u_gtpe2_channel]
...
set_property PLL1_FBDIV 4 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_gtpe2_common]
set_property PLL0_FBDIV 4 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_gtpe2_common]
set_property PLL1_FBDIV_45 4 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_gtpe2_common]
set_property PLL0_FBDIV_45 4 [get_cells u_ibert_core/inst/QUAD[0].u_q*/u_common/u_gtpe2_common]
