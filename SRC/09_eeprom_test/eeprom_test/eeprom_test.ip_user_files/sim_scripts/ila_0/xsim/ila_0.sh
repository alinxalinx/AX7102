...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 6f1e643b1e0544c78f96e2f7c8243b6b -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot ila_0 xil_defaultlib.ila_0 xil_defaultlib.glbl -log elaborate.log
}
